...
def get_args_parser():
    ...
    # * HOI Detection
    parser.add_argument('--HOIDet', default=True,
                        help="Train HOI Detection head if the flag is provided")
    parser.add_argument('--share_enc', default=True,
                        help="Share the Encoder in DETR for HOI Detection if the flag is provided")
    parser.add_argument('--pretrained_dec', default=True,
    ...
    parser.add_argument('--num_hoi_queries', default=16, type=int,
    ...
    parser.add_argument('--dataset_file', default='hico-det', type=str)
    ...
    parser.add_argument('--resume', default='checkpoints/hico_det/hico_q16.pth', help='resume from checkpoint',type=str)
    parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                        help='start epoch')
    parser.add_argument('--num_workers', default=2, type=int)

    # mode
    parser.add_argument('--eval', default=True, type=bool, help="Only evaluate results if the flag is provided")
