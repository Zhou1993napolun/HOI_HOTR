...
class LoadWebcam:  # for inference
    ...
    def __next__(self):
        ...
        img = img0
        # img = letterbox(img0, new_shape=self.img_size)[0]  # optional resize and padding

        return img_path, img, img0, None  # 返回与 LoadImages 类似的格式

    def __len__(self):
        return float('inf')  # infinite length to mimic a webcam stream
